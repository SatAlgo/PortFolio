          ...
          <div className="md:w-1/2 mt-12 md:mt-24 space-y-2 order-2 md:order-1">
            ...
            <div className="flex space-x-1 text-2xl md:text-4xl">
              ...
              <ReactTyped
                ...
                strings={["Devloper", "Coder", "Problem Solver"]}
                typeSpeed={40}
                backSpeed={50}
                loop={true}
              />
            ...
            <p className="text-sm md:text-md text-justify">
              I am Satyam Gaikwad. I am a passionate Full-stack Web Devoper. Now
              I'm persuing my B-tech degree from MIT, Alandi college of
              Engineering, Pune.
            </p>
            <br />
            {/* ---------------------Social Media Icons---------------    */}
            <div className="flex flex-col items-center md:flex-row justify-between space-y-6 md:space-y-0">
              <div className="space-y-2">
                <h1 className="font-bold text-center">Awailable on</h1>
