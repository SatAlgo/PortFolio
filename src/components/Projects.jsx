  ...
  const cardItem = [
    {
      ...
      reviewLink: "https://kitup.netlify.app/",
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5 my-5">
          {cardItem.map(
            ({ id, logo, name, description, reviewLink, sourceLink }) => (
              <div
                className="border-[2px] rounded-lg shadow-lg p-4 cursor-pointer hover:scale-105 duration-300 flex flex-col justify-between h-full"
                key={id}
              >
                ...
                <div className="flex space-x-3 mt-4 flex justify-between">
                  <a
                    href={reviewLink}
                    target="_blank"
