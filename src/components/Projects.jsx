...
function Projects() {
  ...
  const cardItem = [
    ...
    },
    {
      ...
      name: "Snake Game",
      description: "Using Tkinter Python.",
      projectLink: "https://www.linkedin.com/posts/satyam-gaikwad-27a7a724b_python-tkinter-projects-activity-7216086482913009664-bqJy",
      sourceLink: "https://github.com/SatAlgo/Snake-Game",
      details:
        "Classic snake game where user controls direction, implemented in Python Tkinter with score tracking and collision detection.",
    },
    {
      ...
      name: "Tic-Tac-Toe Game",
      description: "Using Tkinter Python",
      reviewLink: "https://www.linkedin.com/posts/satyam-gaikwad-27a7a724b_python-tkinter-coding-activity-7216079181275623424-Bghz",
      sourceLink: "https://github.com/SatAlgo/Tic-Tac-Toe-Game",
      projectLink: "",
      details:
        "2-player game made in Python using Tkinter GUI. Simple interface, win detection, and replay options implemented.",
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5 my-5">
        {cardItem.map((project) => (
          ...
          >
            {/* Desktop hover text */}
            <div
              className={`absolute inset-0 bg-black bg-opacity-50 hidden md:flex flex-col items-center justify-center transition-opacity rounded-md pointer-events-none ${
                hoveredBtnId === project.id
                  ? "opacity-0"
                  : "opacity-0 group-hover:opacity-100"
              }`}
            >
              <small className="text-white text-xs font-light tracking-wide select-none">
                Tap to view more
              </small>
            </div>
            ...
            <div className="mt-2">
              <div className="font-bold text-xl mb-1">{project.name}</div>
              <p className="text-gray-700 text-sm md:text-xs font-semibold">{project.description}</p>

            </div>

            {/* Show details only on mobile */}
            <div className="block md:hidden mt-2">
              <p className="text-gray-900 text-base md:hidden mt-2 font-medium">{project.details}</p>
            </div>
      ...
      {activeProject && (
        ...
        >
          ...
          >
            ...
            <h2 className="text-2xl font-bold text-violet-800 mb-1">{activeProject.name}</h2>
            <p className="text-gray-600 text-sm mb-4">{activeProject.description}</p>
